...
function NestCamAccessory(connection, log, device, structure, platform) {
  NestDeviceAccessory.call(this, connection, log, device, structure, platform);

  const motionSensorService = this.addService(Service.MotionSensor)
...
module.exports = function (exportedTypes) {
  if (exportedTypes && !Service) {
    ...
    NestCamAccessory.prototype.model = NestCamAccessory.model;
  }

...
function NestProtectAccessory(connection, log, device, structure, platform) {
  NestDeviceAccessory.call(this, connection, log, device, structure, platform);

  const smokeSensorService = this.addService(Service.SmokeSensor)
...
module.exports = function (exportedTypes) {
  if (exportedTypes && !Accessory) {
    ...
    NestProtectAccessory.model = 'Protect';
    ...
    NestProtectAccessory.prototype.model = NestProtectAccessory.model;
  }
